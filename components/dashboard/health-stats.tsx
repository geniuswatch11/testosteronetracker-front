                ...
                >
                  ...
                  <Tooltip
                    ...
                    formatter={(value: string | number | (string | number)[] | undefined, name: string) => {
                      // Handle array values (should not happen in this chart)
                      ...
                      switch (name) {
                        case "resting_hr":
                          return [numValue !== null ? `${numValue.toFixed(0)} bpm` : "-", t("charts.restingHr")]
                        case "hrv":
                          return [numValue !== null ? `${numValue.toFixed(0)} ms` : "-", t("charts.hrv")]
                        case "sleep_hours":
                          return [numValue !== null ? `${numValue.toFixed(1)} h` : "-", t("charts.sleepHours")]
                        case "sleep_efficiency":
                          return [numValue !== null ? `${(numValue * 100).toFixed(0)}%` : "-", t("charts.sleepEfficiency")]
                        case "respiratory_rate":
                          return [numValue !== null ? `${numValue.toFixed(1)} rpm` : "-", t("charts.respiratoryRate")]
                        case "spo2":
                          return [numValue !== null ? `${(numValue * 100).toFixed(0)}%` : "-", t("charts.spo2")]
                        case "calories_total":
                          return [numValue !== null ? `${numValue.toFixed(0)} cal` : "-", t("charts.caloriesTotal")]
                        default:
